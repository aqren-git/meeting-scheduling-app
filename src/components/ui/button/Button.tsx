...
export function Button({
  ...
  const base = 'h-9 w-full sm:w-auto px-3 sm:px-4 rounded-md text-sm font-medium inline-flex items-center justify-center gap-1.5 transition-colors duration-150'
  const variants = {
