...
export function Textarea({ label, error, id, className = '', ...props }: TextareaProps) {
  ...
  return (
    <div className="mb-4">
      ...
      <textarea
        id={textareaId}
        className={`w-full h-[72px] p-2 rounded-md border text-sm text-text-primary bg-surface-default outline-none resize-none transition-[border-color,box-shadow] duration-150
